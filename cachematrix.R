  ...
  ## Note on Scoping Rule:       
      ##          a variable, say x, can be accessed, assigned and returned from an 
...
makeCacheMatrix <- function(x = matrix()) {
  ...
  getinverse<-function() i					              ## getmean () will return the inverse
  ...
  ## and cached the mean as the inverse for that matrix to be used later and finally return the inverse value
